# LNG市场分析助手 Skill v4.4 - 汇总版网页报告

**更新时间**: 2026-04-06 20:16  
**更新内容**: 汇总版网页报告、浙江专区增强、lightclaw直链输出
...
| 版本 | 报告形式 | 内容侧重 | 输出方式 |
|-----|---------|---------|---------|
| v4.3 | 完整版 | 12助理详情+数据 | GitHub Pages |
| **v4.4** | **汇总版** | **纯数据+分析** | **GitHub Pages + 直链** |
...
- **lightclaw直链**: 直接上传HTML文件，用户可直接打开
- **双版本保留**: 汇总版(默认) + 完整版(按需)

### 4. 用户偏好记忆
```yaml
user_preferences:
  report_style: "汇总版"  # 用户明确要求不要助理详情
  zhejiang_focus: true    # 浙江专区重点展示
  direct_link: true       # 需要直接可打开的文件链接
  data_confidence: "A级"  # 优先展示A级置信度数据
```
